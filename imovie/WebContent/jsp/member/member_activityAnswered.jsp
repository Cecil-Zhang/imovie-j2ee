...
<div class="container-fluid">
	...
	<div class="row personelrow">
		...
		<div class="col-md-2 personelrow">
			<h6><a href="movieShowPlanAction.do?planId=${plan.planId }">${plan.movie.name }&nbsp;&nbsp; 订单号:${plan.orderId }</a></h6>
            ...
            <p><a role="button" class="btn btn-primary btn-sm col-md-offset-1" href="orderMyQuizAction.do?orderId=${plan.orderId }&movie=${plan.movie.name}">查看活动</a>
		</div>
		</c:forEach>
	</div>
</div>
